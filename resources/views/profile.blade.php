	...
	<div class="col-md-12">
		<div class="profile-header">
			<div class="row align-items-center">
				...
				<div class="col ml-md-n2 profile-user-info">
					...
					Fuso horário: <h5>{{date_default_timezone_get()}}</h5>
                    Data e hora atuais: <h5>{{date('d M,Y h:i:s a', time())}}</h5>
				</div>
		...
		<div class="profile-menu">
			<ul class="nav nav-tabs nav-tabs-solid">
				<li class="nav-item">
					<a class="nav-link active" data-toggle="tab" href="#per_details_tab">Sobre</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-toggle="tab" href="#password_tab">Senha</a>
				</li>
			</ul>
		</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="row">
									<p class="col-sm-2 text-muted text-sm-right mv-0 mb-sm-3">Papel do usuário</p>
									<p class="col-sm-10">
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title">Detalhes persoal</h5>
											...
											<div class="row form-row">
												<div class="col-12">
													<div class="form-group">
														...
														<input class="form-control" name="name" type="text" value="{{auth()->user()->name}}" placeholder="Nome Completo">
													</div>
												</div>
												<div class="col-12">
													<div class="form-group">
