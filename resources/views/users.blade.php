...
<div class="col-sm-5 col">
	<a href="#add_user" data-toggle="modal" class="btn btn-primary float-right mt-2">Adicionar Usuário</a>
</div>
								...
								<td>
									<h2 class="table-avatar">
										...
										<span class="avatar avatar-sm mr-2">
											<img class="avatar-img" src="{{asset('storage/users/'.$user->avatar)}}" alt="imagem">
										</span>
										@endif
										{{$user->name_em}}
									</h2>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Adiconar Usuário</h5>
					...
					<div class="row form-row">
						<div class="col-12">
							<div class="form-group">
								<label>Nome</label>
								<input type="text" name="name_em" class="form-control" placeholder="John Doe">
							</div>
						</div>
						<div class="col-12">
							<div class="form-group">
