...
Route::group(['middleware'=>['auth']],function (){
    ...
    Route::post('categorie-product',[CategoryController::class,'store'])->name('categorie-product');
    // ('categories',[CategoryController::class,'index'])->name('categories');
    // Route::get('add-categorie',[CategoryController::class,'create'])->name('add-categorie');
    // Route::put('categories/{categorie}',[CategoryController::class,'update'])->name('edit-categorie');
    // Route::get('edit-categorie/{id}',[CategoryController::class,'show'])->name('edit-categorie');
    ...
    Route::put('products/{product}',[ProductController::class,'show'])->name('edit-product');
    Route::get('edit-product',[ProductController::class,'show'])->name('edit-product');
    ...
    Route::get('add-sale',[SalesController::class,'create'])->name('add-sale');
    Route::post('add-sale',[SalesController::class,'store']);
    Route::get('sales/{sale}',[PurchaseController::class,'show'])->name('edit-sale');
